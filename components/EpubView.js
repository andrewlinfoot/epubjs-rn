...
import { StyleSheet, View, WebView, Text, Dimensions, TouchableWithoutFeedback, ActivityIndicator, Platform } from 'react-native';
...
class EpubView extends Component {
  ...
  _onLayout(e) {
    ...
    if (this.prevBounds && this.bounds.width === this.prevBounds.width && this.bounds.height === this.prevBounds.height) {
      return;
    }
  ...
  componentWillUpdate(nextProps, nextState) {
    ...
    if (nextState.width && nextState.height && (this.state.width !== nextState.width || this.state.height !== nextState.height)) {
  ...
  */
  ...
  render() {
    ...
    if (!this.state.contents || !this.state.visibility) {
      return <View ref="wrapper" style={[this.props.style, {
        width: this.state.width,
        height: this.state.height,
        backgroundColor: this.props.backgroundColor || "#FFFFFF",
        overflow: "hidden"
      }]} collapsable={false} onLayout={this._onLayout.bind(this)}>
    ...
    return <View ref="wrapper" style={[this.props.style, {
      ...
      backgroundColor: this.props.backgroundColor || "#FFFFFF"
    }]} onLayout={this._onLayout.bind(this)} collapsable={false}>
        <TouchableWithoutFeedback onPress={this.props.onPress}>
        <WebViewer ref="webviewbridge" key={`EpubViewSection:${this.props.section.index}`} style={{
          width: this.state.width,
          height: this.state.innerHeight,
          marginLeft: this.state.marginLeft,
          marginTop: this.state.marginTop,
          backgroundColor: this.props.backgroundColor || "#FFFFFF",
          overflow: "hidden" }} source={{ html: this.state.contents, baseUrl: this.props.origin || DOMAIN }} scalesPageToFit={false} scrollEnabled={false} onLoadEnd={this._onLoad.bind(this)} onMessage={this._onBridgeMessage.bind(this)} javaScriptEnabled={true} />
